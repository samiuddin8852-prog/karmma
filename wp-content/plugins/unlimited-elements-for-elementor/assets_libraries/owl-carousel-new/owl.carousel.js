              ...
              ;(function($, window, document, undefined) {
                ...
                */
                Navigation.prototype.initialize = function() {
                  ...
                  this._controls.$previous = $('<' + settings.navElement + ' aria-label="Previous slide">')
                  ...
                  this._controls.$next = $('<' + settings.navElement + ' aria-label="Next slide">')
                  ...
                  if (!settings.dotsData) {
                    this._templates = [ $('<button role="button" aria-label="Go to slide">')
